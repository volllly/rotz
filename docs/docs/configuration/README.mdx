...
<TabedCodeBlock title="Example:"
    yaml="The file `dot.yaml` contains information about how to install the application and where to link the dotfiles."
    toml="The file `dot.toml` contains information about how to install the application and where to link the dotfiles."
    json="The file `dot.json` contains information about how to install the application and where to link the dotfiles."
    />
